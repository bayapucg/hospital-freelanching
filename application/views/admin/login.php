...
<body style="background-image: url(assets/vendor/img/login-bac.png);background-size:cover;height:100%" >
 <div class="form-title">
      &nbsp;
    </div>
    <!-- Login Form-->
    <div class="login-form text-center">
        <a href="<?php echo base_url(''); ?>"><div class="bg-login-site py-2">
		 <span class="logo-default" ><img style="width:auto;height:40px;" class="img-responsive" src="<?php echo base_url(); ?>assets/vendor/img/logo.png" alt="logo"> </span> 
        </div>
		</a>
