...
<head>
 ...
 <!-- END HEAD -->
<body class="page-header-fixed sidemenu-closed-hidelogo page-content-white page-md header-indigo  logo-indigo">
        ...
        <div class="page-header navbar navbar-fixed-top">
            <div class="page-header-inner ">
                ...
                <div class="page-logo">
                    ...
                    <span class="logo-default" ><img style="width:auto;height:40px;" class="img-responsive" src="<?php echo base_url(); ?>assets/vendor/img/logo.png" alt="logo"> </span> </a>
                </div>
                <!-- logo end -->
